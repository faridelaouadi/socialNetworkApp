                ...
                child: Column(
                  children: <Widget>[
                    ...
                    TextFormField(
                      ...
                      validator: (val) => val.isEmpty ? "Don't leave it empty":null,
                    ...
                    TextFormField(
                      ...
                      validator: (val) => val.length < 6 ? "Password needs to be atleast 6 chars":null,
                    ...
                    RaisedButton(
                      ...
                      onPressed: () async {
                        if(_formKey.currentState.validate()){
                          ...
                          bool result = await _auth.registerEmailPassword(email, password);
                          if (result == false){
                            setState(() {
